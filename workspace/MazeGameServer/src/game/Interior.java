...
public class Interior extends Room {
    ...
    public void generateRandomItems(Game game){
        if(ItemType.randomItem().equals(ItemType.BOMB)) {
            ...
            System.out.println("TOOL ADDED");
            this.addItem(new DisguiseTool(game, this.getCenter().getX(), this.getCenter().getY(), 16, 16));
        } else if(ItemType.randomItem().equals(ItemType.LIFE)) {
            System.out.println("LIFE ADDED");
            this.addItem(new ExtraLife(game, this.getCenter().getX(), this.getCenter().getY(), 16, 16));
        }
        else if(ItemType.randomItem().equals(ItemType.BOOSTER)) {
            System.out.println("BOOSTER ADDED");
            this.addItem(new HealthBooster(game, this.getCenter().getX(), this.getCenter().getY(), 16, 16));
        }
        else if(ItemType.randomItem().equals(ItemType.SHIELD)) {
            System.out.println("SHIELD ADDED");
            this.addItem(new Shield(game,this.getCenter().getX(), this.getCenter().getY(), 16, 16));
        }
