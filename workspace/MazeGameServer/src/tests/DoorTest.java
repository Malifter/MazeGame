...
public class DoorTest {
    ...
    public int xPos;
    public int yPos;
    public Position<Integer, Integer> exitLocation;
    public Room room;
    ...
    public void testDoorLink() {
        initiateTestVariables();
        Door linkedDoor = new Door(game, image, xPos + Door.TILESIZE, yPos, new Position<Integer, Integer>(xPos + (Door.TILESIZE*2), yPos), room, null, Side.LEFT);
        door = null;
    ...
    public void initiateTestVariables() {
        try {
            ...
            xPos = 232;
            yPos = 72;
            exitLocation = new Position<Integer, Integer>(xPos - Door.TILESIZE, yPos);
            side = Side.RIGHT;
            room = new Room(new Position<Integer, Integer>(0,0));
